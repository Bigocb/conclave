/**
 * Conclave — Drizzle ORM Schema (PostgreSQL dialect)
 * Production schema for Render/Postgres deployment.
 * Column names and structure match the SQLite schema for easy migration.
 */
...
export const reviews = pgTable('reviews', {
  ...
  approved: integer('approved').notNull().default(0), // 0 or 1 (PG doesn't have boolean in drizzle text-mode)
