...
CREATE TABLE IF NOT EXISTS agents (
  ...
  instructions TEXT,                 -- custom system prompt (Multica-inspired)
  skills TEXT,                       -- JSON array of skill/context names
  type TEXT DEFAULT 'llm',            -- reviewer backend: llm | slim | code | pipeline
  command TEXT,                       -- shell command for type=code reviewers
